...
module.exports = {
    ...
    variants: {
      safelist: [
        ...
        "flex absolute flex-row text-center text-gray-800 text-lg top-56 xl:flex-row max-w-[500px] items-center snap-center",
        "flex absolute flex-row text-gray-800 text-md top-18 items-center max-w-600px px-10]",
        "absolute top-16 uppercase tracking-[17px] text-gray-800 text-2xl sm:text-gray-800 sm:text-base md:text-gray-800 lg:text-gray-800 xl:text-gray-800",
        "absolute top-24 uppercase tracking-[20px] text-gray-800 text-2xl sm:text-gray-800",
        "absolute top-24 uppercase tracking-[17px] text-gray-800 text-2xl sm:text-gray-800",
        "absolute top-44 uppercase tracking-[15px] text-gray-800 text-xl sm:text-gray-800",
        "absolute bottom-48 uppercase tracking-[2px] text-gray-800 text-md marker:mb-10",
        "snap-mandatory min-h-screen dark:bg-gray-800 dark:text-gray-300"
      ],
    },
    theme: {
      extend: {

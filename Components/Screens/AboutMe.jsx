  ...
  return (
    <>
      <div className="flex relative flex-col text-center md:text-left xl:flex-row  xl:px-10 min-h-screen justify-center xl:space-y-0 mx-auto items-center snap-center">
          <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-800 text-2xl sm:text-gray-800 dark:text-gray-900">
            Bio
          </h3>
          <h6 className="absolute top-44 uppercase tracking-[15px] text-gray-800 text-xl sm:text-gray-800 dark:text-gray-900">
            Aaron Daley
          </h6>
          <div className="flex absolute flex-row text-center text-gray-800 text-lg top-56 xl:flex-row max-w-[500px] items-center snap-center dark:text-gray-900">

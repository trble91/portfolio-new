...
export default function Form() {
  return (
    ...
    <form action="/api/form" method="post" className='text-gray-400 text-2xl sm:text-gray-100'>
      ...
      <button type="submit" className="bg-gray-100 hover:bg-gray-300 text-gray-400 text-lg font-thin uppercase border rounded-2xl border-gray-400 shadow mt-5 py-2 px-4 p-1 pr-2 pl-2">Submit</button>
    </form>
    </motion.div>
    </>
  )
